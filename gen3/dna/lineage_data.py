...
LINEAGE_DATA = {
    ...
    "Tiefling": {
        ...
        "skin_options": {
            "Brick Red": "brick-red infernal skin pigmentation",
            "Crimson Red": "crimson-red infernal skin pigmentation",
            "Deep Crimson": "deep crimson infernal skin pigmentation",
            "Burgundy": "burgundy infernal skin pigmentation",
            "Dark Red": "dark red infernal skin pigmentation",
            "Scarlet": "scarlet infernal skin pigmentation",
            "Maroon": "maroon infernal skin pigmentation",
            "Dark Blue (Variant)": "dark blue infernal skin pigmentation",
            "Human Range": "skin pigmentation within the full human range",
        },
    ...
    "Kender": {
        "category": "fey", "body_type": "small fey humanoid", "heritage_compatible": True,
        "prompt": "a Kender character",
        "body_plan": {
            "posture": "bipedal", "body": "small nimble fey humanoid", "head": "fey humanoid",
            "limbs": "humanoid", "hands": "nimble humanoid hands", "feet": "small humanoid feet",
            "build": "small and lightly built", "hair_allowed": True, "facial_hair_allowed": False,
        },
        "negative_prompt": "giant proportions, dwarf body, animal muzzle",
        "features": {"horns": False, "tail": False, "wings": False, "scales": False, "claws": False},
        "face_model": "humanoid", "face_allowed": True,
        "traits": {"ears": "distinctive pointed ears", "eyes": "humanoid", "nose": "humanoid", "mouth": "humanoid", "skin": "skin"},
    },
    "Merfolk": {
        "category": "aquatic", "body_type": "aquatic humanoid", "heritage_compatible": False,
        "prompt": "a merfolk character",
        "body_plan": {
            "posture": "upright aquatic humanoid", "body": "humanoid torso with aquatic lower body",
            "head": "humanoid aquatic head", "limbs": "humanoid upper limbs",
            "hands": "humanoid hands", "feet": "no human feet", "tail": "long fish-like tail",
            "hair_allowed": True, "facial_hair_allowed": True,
        },
        "negative_prompt": "human legs, human feet, ordinary terrestrial lower body",
        "features": {"horns": False, "tail": True, "wings": False, "scales": True, "claws": False},
        "face_model": "humanoid", "face_allowed": True,
        "traits": {"ears": "aquatic humanoid ears", "eyes": "aquatic eyes", "nose": "humanoid", "mouth": "humanoid", "skin": "aquatic skin and scales"},
        "feature_loci": {"scale_pattern": ["fine", "subtle", "overlapping"]},
    },
    "Fairy Folk": {
        "category": "fey", "body_type": "small winged fey humanoid", "heritage_compatible": True,
        "prompt": "a Fairy Folk character",
        "body_plan": {
            "posture": "bipedal", "body": "small delicate fey humanoid", "head": "fey humanoid",
            "limbs": "humanoid", "hands": "small humanoid hands", "feet": "small humanoid feet",
            "wings": "delicate translucent fairy wings",
            "hair_allowed": True, "facial_hair_allowed": False,
        },
        "negative_prompt": "ordinary human anatomy, missing wings, giant proportions",
        "features": {"horns": False, "tail": False, "wings": True, "scales": False, "claws": False},
        "face_model": "humanoid", "face_allowed": True,
        "traits": {"ears": "delicate pointed ears", "eyes": "fey eyes", "nose": "humanoid", "mouth": "humanoid", "skin": "skin"},
        "feature_loci": {"wing_type": ["translucent", "gossamer", "iridescent"]},
    },
    "Aasimar": {
